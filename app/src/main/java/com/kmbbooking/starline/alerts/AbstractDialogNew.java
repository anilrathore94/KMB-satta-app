...
public class AbstractDialogNew implements DialogInterface {
    ...
    protected DialogButtonNew mPositiveButton;
    protected DialogButtonNew mNegativeButton;
    ...
    protected AbstractDialogNew(@NonNull Activity mActivity,
    ...
    protected View createView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container) {
        ...
        final View dialogView = inflater.inflate(R.layout.layout_alert_dialog_n, container, false);
        ...
        if (mPositiveButton != null) {
            ...
            mPositiveButtonView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    mPositiveButton.getOnClickListener().onClick(AbstractDialogNew.this, BUTTON_POSITIVE);
                }
            });
        } else {

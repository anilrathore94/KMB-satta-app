...
import com.kmbbooking.starline.alerts.model.DialogButtonNew;
...
public class BottomSheetMaterialDialogNew extends AbstractDialogNew {
    ...
    protected BottomSheetMaterialDialogNew(@NonNull final Activity mActivity,
                                           @NonNull String title,
                                           @NonNull String message,
                                           boolean mCancelable,
                                           @NonNull DialogButtonNew mPositiveButton,
                                           @RawRes int mAnimationResId,
                                           @NonNull String mAnimationFile) {
        super(mActivity, title, message, mCancelable, mPositiveButton, mAnimationResId, mAnimationFile);
    ...
    /**
     * Builder for {@link BottomSheetMaterialDialogNew}.
     */
    public static class Builder {
        ...
        public Builder setPositiveButton(@NonNull String name, int icon, @NonNull OnClickListener onClickListener) {
            positiveButton = new DialogButtonNew(name, icon, onClickListener);
            return this;
        }
        ...
        public Builder setNegativeButton(@NonNull String name, int icon, @NonNull OnClickListener onClickListener) {
            negativeButton = new DialogButtonNew(name, icon, onClickListener);
            return this;
        }
        ...
        /**
         * Build the {@link BottomSheetMaterialDialogNew}.
         */
        @NonNull
        public BottomSheetMaterialDialogNew build() {
            return new BottomSheetMaterialDialogNew(activity, title, message, isCancelable, positiveButton, animationResId, animationFile);
        }
    }

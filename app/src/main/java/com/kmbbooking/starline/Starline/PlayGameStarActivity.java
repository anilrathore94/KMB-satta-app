...
import com.kmbbooking.starline.Activity.Deposit;
import com.kmbbooking.starline.R;
import com.kmbbooking.starline.adapters.GamePlayStarAdapter;
...
public class PlayGameStarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play__game__star);
        ...
        btSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if (gameType.equalsIgnoreCase("Jodi")) {
                ...
                if (Integer.parseInt(etPoints.getText().toString().trim()) < Integer.parseInt(Saurya.ReadStringPreferences(SharedPrefData.MIN_BID)) ||
                    ...
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(com.kmbbooking.starline.Starline.PlayGameStarActivity.this);
                ...
                saveEntry(tvDate.getText().toString(), sessionType,
                        ...
                        open_digit, close_digit, String.valueOf(Integer.parseInt(etPoints.getText().toString())));
        ...
        database = new DatabaseGamePlay(com.kmbbooking.starline.Starline.PlayGameStarActivity.this);
        sqLiteDatabase = database.getWritableDatabase();
        ...
        updateFragmentAdapters = new GamePlayStarAdapter(com.kmbbooking.starline.Starline.PlayGameStarActivity.this, notificationsModelArrayList);
                        ...
                        if (cursor.getCount() > 0) {
                            ...
                            if (cursor.moveToFirst()) {
                                do {
                                    ...
                                    if (gameType.equalsIgnoreCase("Single Digit")) {
                                        cust.put("pana", "");
                                        cust.put("digit", push_open_digit);


                                    } else {
                                        cust.put("pana", push_open_pana);
                                        cust.put("digit", "");
                                    }
    ...
    private void Regist(final String bidData) {
        ...
        mAPIService.newStarBid(bidData).enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, retrofit2.Response<JsonObject> response) {
                ...
                try {
                    ...
                    if (jsonObject.optString("success").equalsIgnoreCase("1")) {
                        ...
                        BottomSheetMaterialDialog mAnimatedBottomSheetDialoga = new BottomSheetMaterialDialog.Builder(com.kmbbooking.starline.Starline.PlayGameStarActivity.this)
                                .setTitle("Success?")
                                ...
                                .setNegativeButton("Cancel", R.drawable.ss, new BottomSheetMaterialDialog.OnClickListener() {
                                    ...
                                    public void onClick(com.kmbbooking.starline.alerts.interfaces.DialogInterface dialogInterface, int which) {
                                        Intent mainIntent = new Intent(com.kmbbooking.starline.Starline.PlayGameStarActivity.this, com.kmbbooking.starline.Starline.HomeStarLineActivity.class);
                        ...
                        alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent intent = new Intent(com.kmbbooking.starline.Starline.PlayGameStarActivity.this, Deposit.class);

...
import com.kmbbooking.starline.adapters.BidHistoryStarAdapter;
...
public class BidHistoryStarLineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                datepicker = new DatePickerDialog(com.kmbbooking.starline.Starline.BidHistoryStarLineActivity.this,
    ...
    private void getAllBidHistory() {
        ...
        mAPIService.getBidStarReport(Saurya.ReadStringPreferences(SharedPrefData.PREF_LOGINPHONE), StartDate, EndDate).enqueue(new Callback<JsonObject>() {
            @Override
                ...
                try {
                    ...
                    if (Message.equalsIgnoreCase("[]")) {
                        ...
                        for (int i = 0; i < jsonArrayFeeList.length(); i++) {
                            ...
                            updateFragmentModel.setSession("OPEN");

                            updateFragmentModel.setOpen_pana(jsonObjectFeeList.getString("pana"));
                            updateFragmentModel.setOpen_digit(jsonObjectFeeList.getString("digit"));

...
public class PaytmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        type.setText("Update PayTM No");
        typeNo.setText("PayTM Mobile No");
        tvMobile.setHint("Enter PayTM Mobile No");
    ...
    private void Regist() {
        ...
        mAPIService.updateProfile(Saurya.ReadStringPreferences(SharedPrefData.PREF_LOGINPHONE), phonePe, gpay, tvMobile.getText().toString()).enqueue(new Callback<JsonObject>() {
            @Override
        ...
        mAPIService.getProfile(Saurya.ReadStringPreferences(SharedPrefData.PREF_LOGINPHONE)).enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, retrofit2.Response<JsonObject> response1) {
                ...
                try {
                    ...
                    tvMobile.setText(json.optString("paytm"));

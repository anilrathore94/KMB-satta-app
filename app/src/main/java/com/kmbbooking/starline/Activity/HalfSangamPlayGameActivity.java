...
import com.kmbbooking.starline.adapters.GamePlayHalfAdapter;
...
public class HalfSangamPlayGameActivity extends AppCompatActivity {
    ...
    private static GamePlayHalfAdapter updateFragmentAdapters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_half);

        Toolbar toolbar = findViewById(R.id.toolbar);
        TextView tvS = toolbar.findViewById(R.id.titleToolbar);
        tvS.setText("Half Sangam");
        ...
        if (extras != null) {
            ...
            myAutoComplete.setHint("Open Digit");
        ...
        btSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Integer.parseInt(etValue.getText().toString().trim()) < Integer.parseInt(Saurya.ReadStringPreferences(SharedPrefData.MIN_BID)) ||
                    ...
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(HalfSangamPlayGameActivity.this);
        ...
        database = new DatabaseGamePlay(HalfSangamPlayGameActivity.this);
        sqLiteDatabase = database.getWritableDatabase();
        ...
        updateFragmentAdapters = new GamePlayHalfAdapter(HalfSangamPlayGameActivity.this, notificationsModelArrayList);
    ...
    private void saveEntry(String push_Date, String push_session, String push_open_pana, String push_close_pana,
        ...
        try {
            ...
            contentValues.put("push_type", "Open Digit");
            ...
            public void onResponse(Call<JsonObject> call, retrofit2.Response<JsonObject> response) {
                ...
                try {
                    ...
                    if (jsonObject.optString("success").equalsIgnoreCase("1")) {
                        ...
                        BottomSheetMaterialDialog mAnimatedBottomSheetDialoga = new BottomSheetMaterialDialog.Builder(HalfSangamPlayGameActivity.this)
                                .setTitle("Success?")
                                ...
                                .setNegativeButton("Cancel", R.drawable.ss, new BottomSheetMaterialDialog.OnClickListener() {
                                    ...
                                    public void onClick(com.kmbbooking.starline.alerts.interfaces.DialogInterface dialogInterface, int which) {
                                        Intent mainIntent = new Intent(HalfSangamPlayGameActivity.this, HomeActivity.class);

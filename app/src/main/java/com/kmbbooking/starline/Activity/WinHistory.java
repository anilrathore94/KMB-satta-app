...
import com.kmbbooking.starline.adapters.WinHistoryAdapter;
...
public class WinHistory extends AppCompatActivity {
    ...
    private static WinHistoryAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleToolbar.setText("Winning History");
        ...
        mAdapter = new WinHistoryAdapter(GetDownloadCategoryModelArrayList);
        ...
        edtStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                datepicker = new DatePickerDialog(WinHistory.this,
    ...
    private void getAllWinHistory() {
        ...
        mAPIService.getWinReport(Saurya.ReadStringPreferences(SharedPrefData.PREF_LOGINPHONE), StartDate, EndDate).enqueue(new Callback<JsonObject>() {
            @Override

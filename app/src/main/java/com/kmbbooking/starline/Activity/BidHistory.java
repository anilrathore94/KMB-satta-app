...
import com.kmbbooking.starline.adapters.BidHistoryAdapter;
...
public class BidHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleToolbar.setText("Bid History");
        ...
        edtStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                datepicker = new DatePickerDialog(BidHistory.this,
    ...
    private void getAllBidHistory() {
        ...
        mAPIService.getBidReport(Saurya.ReadStringPreferences(SharedPrefData.PREF_LOGINPHONE), StartDate, EndDate).enqueue(new Callback<JsonObject>() {
            @Override
                ...
                try {
                    ...
                    if (Message.equalsIgnoreCase("[]")) {
                        ...
                        for (int i = 0; i < jsonArrayFeeList.length(); i++) {
                            ...
                            BidHistoryData updateFragmentModel = new BidHistoryData();
                            updateFragmentModel.setBid_id(jsonObjectFeeList.getString("bid_id"));
                            ...
                            updateFragmentModel.setSession(jsonObjectFeeList.getString("session"));
                            ...
                            updateFragmentModel.setClose_pana(jsonObjectFeeList.getString("close_pana"));
                            updateFragmentModel.setClose_digit(jsonObjectFeeList.getString("close_digit"));
                            updateFragmentModel.setPoints(jsonObjectFeeList.getString("points_action"));

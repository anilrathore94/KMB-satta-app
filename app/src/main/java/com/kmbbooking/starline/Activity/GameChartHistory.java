...
import com.kmbbooking.starline.adapters.GameChartAdapter;
...
public class GameChartHistory extends AppCompatActivity {
    ...
    private static GameChartAdapter mAdapter;
    String gameName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new GameChartAdapter(GetDownloadCategoryModelArrayList);
    ...
    private void getAllBidHistory() {
        ...
        mAPIService.GET_GAME_CHART().enqueue(new Callback<JsonObject>() {
            @Override
                ...
                try {
                    ...
                    if (Message.equalsIgnoreCase("[]")) {
                        ...
                        for (int i = 0; i < jsonArrayFeeList.length(); i++) {
                            ...
                            updateFragmentModel.setClose_number(jsonObjectFeeList.getString("close_number"));
                        ...
                        if (GetDownloadCategoryModelArrayList.size() > 0) {
                            ...
                            AlertDialog.Builder alertDialog = new AlertDialog.Builder(GameChartHistory.this);

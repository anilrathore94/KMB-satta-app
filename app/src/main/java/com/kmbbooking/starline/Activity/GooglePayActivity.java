...
public class GooglePayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        type.setText("Update GooglePay No");
        typeNo.setText("GooglePay Mobile No");
        tvMobile.setHint("Enter GooglePay Mobile No");
    ...
    private void Regist() {
        ...
        mAPIService.updateProfile(Saurya.ReadStringPreferences(SharedPrefData.PREF_LOGINPHONE), phonePe, tvMobile.getText().toString(), paytm).enqueue(new Callback<JsonObject>() {
            @Override
        ...
        mAPIService.getProfile(Saurya.ReadStringPreferences(SharedPrefData.PREF_LOGINPHONE)).enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, retrofit2.Response<JsonObject> response1) {
                ...
                try {
                    ...
                    tvMobile.setText(json.optString("googlepay"));

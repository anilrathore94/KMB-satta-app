...
import com.kmbbooking.starline.Activity.FullSangamPlayGameActivity;
...
public class GamePlayFullAdapter extends BaseAdapter {
    ...
    public GamePlayFullAdapter(Activity updateffagmentDetailsActivity, List<GamePlayModel> UpdateFragmentModel1) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
            ...
            public void onClick(View view) {
                ...
                alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        FullSangamPlayGameActivity.deleteRowNew(model.getId());
                        dialog.cancel();
        ...
        holder.tvDivision1.setText( model.getOpen_pana());

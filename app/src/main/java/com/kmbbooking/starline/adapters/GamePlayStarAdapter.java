...
import com.kmbbooking.starline.Starline.PlayGameStarActivity;
...
public class GamePlayStarAdapter extends BaseAdapter {
    ...
    public GamePlayStarAdapter(Activity updateffagmentDetailsActivity, List<GamePlayModel> UpdateFragmentModel1) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.layout_course_report, null);
            ...
            public void onClick(View view) {
                ...
                alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        PlayGameStarActivity.deleteRowNew(model.getId());
                        dialog.cancel();
